...
export const metadata: Metadata = {
  title: "Claude Code, Cursor, v0 : quel outil IA choisir en 2026 ? — GregoDev",
  description:
    "Comparatif honnête de Claude Code, Cursor, v0 et Lovable : pour qui, pour quoi, et lequel choisir selon votre projet.",
};
