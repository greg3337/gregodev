...
export const metadata: Metadata = {
  ...
  description:
    "Estimez le budget de votre projet web en 3 questions. Site vitrine à partir de 490€, application SaaS dès 1 500€. Devis personnalisé gratuit en 48h à Bordeaux.",
  keywords: [
